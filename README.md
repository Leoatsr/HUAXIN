[README.md](https://github.com/user-attachments/files/26857287/README.md)
<div align="center">
...
| 环境音 | 🌿 5 种程序化自然音 + **竹签摇签音效** |
| 多语言 | **8 种**（中/英/日/韩/泰/俄/德/法）· 每语言 113 UI 词条 |
| 地图交互 | 高德标准（双击放大 · 右键缩小 · 比例尺 · 重置按钮）|
